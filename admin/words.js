...
systemDictionary = {
    "niu adapter settings": {
        en: "Adapter settings for niu",
        de: "Adaptereinstellungen für niu",
        ru: "Настройки адаптера для niu",
        pt: "Configurações do adaptador para niu",
        nl: "Adapterinstellingen voor niu",
        fr: "Paramètres d'adaptateur pour niu",
        it: "Impostazioni dell'adattatore per niu",
        es: "Ajustes del adaptador para niu",
        pl: "Ustawienia adaptera dla niu",
        "zh-cn": "niu的适配器设置",
    },
    "App Email": {
        en: "App Email",
